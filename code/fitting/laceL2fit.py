...
file1 = "/mnt/data/SYC/xasfitting/exp/LaCe_La_L2_merged.txt"
root_dir = "/mnt/data/SYC/xasfitting/full_LaCe_doublelayer/2result/mu"  
prominence = 0.03
distance = 5
fit_half_window = 10
    ...
    if dirpath.endswith("L2"):  # L2
        ...
        if os.path.exists(file2):
            try:
                ...
                plt.legend()
                plt.tight_layout()
                plt.savefig(f"/mnt/data/SYC/xasfitting/full_LaCe_doublelayer/2result/picla/La-L2-{os.path.basename(os.path.dirname(file2))}.png")
                plt.show()
                i+=1
...
out_csv = "/mnt/data/SYC/xasfitting/full_LaCe_doublelayer/2result/picla/LaCe_L2_peak_fitting_results.csv"
