...
file1 = "/mnt/data/SYC/xasfitting/proced/ZIF-8-La-L2.txt"
    ...
    if dirpath.endswith("L2"):  # L2
        ...
        if os.path.exists(file2):
            try:
                ...
                plt.legend()
                plt.tight_layout()
                plt.savefig(f"/mnt/data/SYC/xasfitting/full_LaCe_doublelayer/zif8/la/La-L2-{os.path.basename(os.path.dirname(file2))}.png")
                plt.close()
                #plt.show()
                i+=1
...
out_csv = "/mnt/data/SYC/xasfitting/full_LaCe_doublelayer/zif8/La_L2_peak_fitting_results.csv"
